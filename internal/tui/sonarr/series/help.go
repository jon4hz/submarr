...
var DefaultKeyMap = KeyMap{
	...
	AutomaticSearch:   key.NewBinding(key.WithKeys("ctrl+a"), key.WithHelp("ctrl+a", "search for season")),
	InteractiveSearch: key.NewBinding(key.WithKeys("ctrl+i"), key.WithHelp("ctrl+i", "interactive search")),
}
